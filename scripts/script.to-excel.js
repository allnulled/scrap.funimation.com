...
for (let index = 0; index < datos_json.length; index++) {
    ...
    const dato_expandido = ((item) => {
        ...
        item_expandido.description = item.synopsis.longSynopsis || item.synopsis.mediumSynopsis || "-";
        ...
        return sort_properties(dato_final, [
            ...
            "synopsis.medium",
            "synopsisExt.en.long",
            "synopsisExt.en.medium",
            "synopsisExt.en.short",
            "synopsisExt.es.long",
            "synopsisExt.es.medium",
            "synopsisExt.es.short",
            "synopsisExt.pt.long",
            "synopsisExt.pt.medium",
            "synopsisExt.pt.short",
            "synopsisExt.ru.long",
            "synopsisExt.ru.medium",
            "synopsisExt.ru.short",
            "synopsisExt.fr.long",
            "synopsisExt.fr.medium",
            "synopsisExt.fr.short",
            "synopsisExt.de.long",
            "synopsisExt.de.medium",
            "synopsisExt.de.short",
            "maturity.bra",
            "maturity.ca",
            "maturity.irl",
            "maturity.mex",
